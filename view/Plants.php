...
<body>
    ...
    <section class="bg-[#1A0B2D] pt-5 w-auto">
        <form action="" method="post">
            <div class="max-w-xl m-auto mb-5">
                <div class="flex space-x-4">
                    <div class="flex rounded-md overflow-hidden w-full">
                        <input type="text" placeholder="Plant Name" name="PlantName"
                            class="pl-2 w-full bg-purple-500 font-bold rounded-md rounded-r-none placeholder-black" />
                        <button type="submit" name="searchByName"
                            class="bg-purple-700 text-white px-6 text-lg font-semibold py-4 rounded-r-md  hover:bg-purple-900 duration-200">Go</button>
                    </div>
        ...
        <form class="max-w-lg m-auto flex flex-col  items-center" action="" method="post">
            ...
            <input type="submit" value="Search" name="searchByCategory"
                class="w-1/2 py-2  mt-3 rounded-md bg-purple-500 text-white font-semibold cursor-pointer hover:bg-purple-700 transition duration-300">
        </form>
    </section>
